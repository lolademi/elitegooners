...
class Hello extends React.Component {
    render() {
      return (
        <div class="column">
        <div class="square"><div class="img">{this.props.img}</div></div>
        <div class="details">
          <div class="text-center">
            <h3 id="M1-NAME" class="font-mono text-2xl">{this.props.name}</h3>
